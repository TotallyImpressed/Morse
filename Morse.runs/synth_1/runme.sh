...
HD_PWD='/home/impressed/Documents/FPGA/Morse/Morse.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log onAir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source onAir.tcl
